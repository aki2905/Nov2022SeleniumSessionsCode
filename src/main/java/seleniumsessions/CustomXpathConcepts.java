...
public class CustomXpathConcepts {
	...
	public static void main(String[] args) {
		...
		// p[text()='Freshworks makes ridiculously easy-to-use marketing, sales, support
		// and IT solutions.']
...
//				parent//child --> direct+indirect
		...
		// a[contains(text(),'Ali
		// khan')]/../preceding-sibling::td/input[@type='checkbox']
		// a[text()='Romi
		// singh']/parent::td/preceding-sibling::td/input[@type='checkbox']
		// a[text()='deepti
