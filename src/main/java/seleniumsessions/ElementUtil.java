...
public class ElementUtil {
	...
	public void getElementArributes(By locator, String attrName) {
	...
	public List<WebElement> getDropDownOpionsList(By locator) {
		Select select = new Select(getElement(locator));
	...
	public void SelectDropdownValue(By locator, String expectedVal) {
		List<WebElement> optionsList = getDropDownOpionsList(locator);
		for (WebElement e : optionsList) {
			String text = e.getText();
