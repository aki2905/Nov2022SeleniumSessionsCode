...
//Can use this:
//		//Using Action class for Sendkeys:
//			Actions act1= new Actions(driver);
//			WebElement ele = null;
//			act1.moveToElement(ele).sendKeys("ABCD");
//			act1.sendKeys(ele, "ABCD");
//			act1.moveToElement(ele).click().sendKeys("ABCD");
//			act1.moveToElement(ele).pause(Duration.ofSeconds(2000)).click().sendKeys("ABCD");
//		
	}
